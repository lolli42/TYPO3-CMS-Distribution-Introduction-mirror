...
Configures meta information for the website. It's possible this template remains empty because most of the information is handled by constants, which are not allowed here. Constant settings belong to the root.
*/
